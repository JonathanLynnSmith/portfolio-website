<footer class="bg-gray-900 text-white py-12">
  <div class="max-w-screen-xl mx-auto px-6">
    ...
    <div
      class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-12 mb-10 text-center lg:justify-center"
    >
      <div>
      ...
      <div>
        <h3 class="text-xl font-semibold text-white mb-4">Connect</h3>
        <ul class="space-y-3">
          <li>
            <a
    ...
    <div class="text-center text-gray-400">
      <p>&copy; 2025 Jonathan Smith LLC. All rights reserved.</p>
    </div>
  </div>
</footer>
